...
def generate_policy_data_beam(data_config_path, sample_config_path, policy_model_path, value_model_path):
    ...
    elif 'scienceqa' in dataset_name or 'solution' in dataset_name:
...
def train_policy_value():
    ...
    policy_model_path = "models/llava-v1.5-7b-sft-policy-v2"
    value_model_path = "models/llava-v1.5-7b-sft-prm-v5-best"
...
if __name__ == "__main__":
    ...
    # verified_data = "output/verified_data/scienceqa/init_v0/scienceqa_train_0_999.jsonl"
    ...
    # value_data = "output/value_data/scienceqa/init_v0/scienceqa_0_1000.jsonl"
    # convert_jsonl_to_json(value_data, value_data.replace("jsonl", "json"))
    ...
    # value_config_path = "config/value_config.json"
    # model_file_path = "models/model.py"
    sample_config_path = "config/sample_config_sci.yaml"
    ...
    # scienceqa v0
    policy_model_path = 'scienceqa/policy/llava-v1.5-7b-policy-v0'
    value_model_path = 'scienceqa/value/llava-v1.5-7b-prm-v0'
    # update_model_paths(policy_config_path, value_config_path, model_file_path)
    # # verified_file, policy_file = generate_policy_data(data_config_path)
    trace_file = generate_policy_data_beam(data_config_path, sample_config_path, policy_model_path, value_model_path)
